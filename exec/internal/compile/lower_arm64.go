...
const (
	...
	APushWasmStack = arm64.ALAST + iota
...
// lowerARM64 converts symbolic instructions into concrete x86-64 instructions.
func (b *ARM64Backend) lowerARM64(builder *asm.Builder) {
	var (
		regs = &dirtyRegs{}
		inst = builder.Root()
	)
...
func (b *ARM64Backend) emitLoadLocalsFirstElem(inst *obj.Prog, builder *asm.Builder, regs *dirtyRegs) {
...
func (b *ARM64Backend) emitLoadGlobalsSliceHeader(inst *obj.Prog, builder *asm.Builder, regs *dirtyRegs) {
...
func (b *ARM64Backend) emitWasmStackLoad(inst *obj.Prog, builder *asm.Builder, regs *dirtyRegs) {
...
func (b *ARM64Backend) emitWasmStackPush(inst *obj.Prog, builder *asm.Builder, regs *dirtyRegs) {
	// movq r14,     [r10] (if not already loaded)
	// movq r13,     [r10+8] (if not already loaded)
	// leaq r12,     [r14 + r13*8]
	// movq [r12],   <data>
