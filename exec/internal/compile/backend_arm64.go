...
// ARM64Backend is the native compiler backend for arm64 architectures.
...
func (b *ARM64Backend) Build(candidate CompilationCandidate, code []byte, meta *BytecodeMetadata) ([]byte, error) {
	...
	b.lowerARM64(builder)

	if err := peepholeOptimizeARM64(builder); err != nil {
...
func (b *ARM64Backend) paramsForMemoryOp(op byte) (size uint, inst obj.As) {
	switch op {
...
func (b *ARM64Backend) emitSymbolicPopToReg(builder *asm.Builder, ci currentInstruction, reg int16) {
...
func (b *ARM64Backend) emitSymbolicPushFromReg(builder *asm.Builder, ci currentInstruction, reg int16) {
	prog := builder.NewProg()
...
func (b *ARM64Backend) emitFusedConstStore(builder *asm.Builder, code []byte, nextInst InstructionMetadata, ci, nextCI currentInstruction, imm uint64) error {
	prog := builder.NewProg()
	prog.As = x86.AMOVQ
	prog.To.Type = obj.TYPE_REG
...
func (b *ARM64Backend) emitWasmMemoryLoad(builder *asm.Builder, ci currentInstruction, outReg int16, base uint64) error {
...
func (b *ARM64Backend) emitWasmMemoryStore(builder *asm.Builder, ci currentInstruction, base uint64, inReg int16) error {
	// <load offset> --> r9
	// addq    r9, $(base)
	// movq   rcx, r9
	// addq   rcx, $(movSize)
...
func (b *ARM64Backend) emitWasmLocalsLoad(builder *asm.Builder, ci currentInstruction, reg int16, index uint64) {
	// movq rbx, $(index)
...
func (b *ARM64Backend) emitWasmGlobalsLoad(builder *asm.Builder, ci currentInstruction, reg int16, index uint64) {
	// movq rbx, $(index)
...
func (b *ARM64Backend) emitWasmGlobalsSave(builder *asm.Builder, ci currentInstruction, reg int16, index uint64) {
	// movq rbx, $(index)
	// loadGlobalsSliceHeader (symbolic)
	// leaq r12, [r15 + rbx*8]
	// movq [r12], reg
...
func (b *ARM64Backend) emitWasmLocalsSave(builder *asm.Builder, ci currentInstruction, reg int16, index uint64) {
	// movq rbx, $(index)
	// loadLocalsFirstElem (symbolic)
	// leaq r12, [r15 + rbx*8]
	// movq [r12], reg
...
func (b *ARM64Backend) emitBinaryI64(builder *asm.Builder, ci currentInstruction) error {
	b.emitSymbolicPopToReg(builder, ci, x86.REG_R9)
	b.emitSymbolicPopToReg(builder, ci, x86.REG_AX)
...
func (b *ARM64Backend) emitBinaryFloat(builder *asm.Builder, ci currentInstruction) error {
...
func (b *ARM64Backend) emitComparisonFloat(builder *asm.Builder, ci currentInstruction) error {
	// xor rax, rax
...
func (b *ARM64Backend) emitRHSConstOptimizedInstruction(builder *asm.Builder, ci currentInstruction, immediate uint64) error {
	b.emitSymbolicPopToReg(builder, ci, x86.REG_AX)
...
func (b *ARM64Backend) emitShiftI64(builder *asm.Builder, ci currentInstruction) error {
...
func (b *ARM64Backend) emitConvertIntToFloat(builder *asm.Builder, ci currentInstruction) error {
	b.emitSymbolicPopToReg(builder, ci, x86.REG_AX)
...
func (b *ARM64Backend) emitPushImmediate(builder *asm.Builder, ci currentInstruction, c uint64) {
	prog := builder.NewProg()
	prog.As = x86.AMOVQ
	prog.From.Type = obj.TYPE_CONST
...
func (b *ARM64Backend) emitDivide(builder *asm.Builder, ci currentInstruction) {
	b.emitSymbolicPopToReg(builder, ci, x86.REG_R9)
	b.emitSymbolicPopToReg(builder, ci, x86.REG_AX)
...
func (b *ARM64Backend) emitComparison(builder *asm.Builder, ci currentInstruction) error {
...
func (b *ARM64Backend) emitUnaryComparison(builder *asm.Builder, ci currentInstruction) error {
	b.emitSymbolicPopToReg(builder, ci, x86.REG_BX)
...
func (b *ARM64Backend) emitSelect(builder *asm.Builder, ci currentInstruction) error {
	b.emitSymbolicPopToReg(builder, ci, x86.REG_R9)
	b.emitSymbolicPopToReg(builder, ci, x86.REG_AX)
	b.emitSymbolicPopToReg(builder, ci, x86.REG_BX)
...
func (b *ARM64Backend) exitInstructions(builder *asm.Builder, status CompletionStatus) (*obj.Prog, *obj.Prog) {
...
func (b *ARM64Backend) emitExit(builder *asm.Builder, status CompletionStatus, flush bool) {
	if flush {
		f := builder.NewProg()
